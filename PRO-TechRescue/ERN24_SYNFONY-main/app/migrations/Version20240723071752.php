 ...
 */
final class Version20240723071752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facturation (id INT AUTO_INCREMENT NOT NULL, invoice_number VARCHAR(20) NOT NULL, invoice_date DATE NOT NULL, due_date DATE NOT NULL, total_amount NUMERIC(10, 2) NOT NULL, tax_amount NUMERIC(10, 2) NOT NULL, value LONGTEXT NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, client_id INT NOT NULL, UNIQUE INDEX UNIQ_17EB513A2DA68207 (invoice_number), INDEX IDX_17EB513A19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, status VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, user_id INT NOT NULL, technicien_id INT DEFAULT NULL, intervention_id INT DEFAULT NULL, INDEX IDX_97A0ADA3A76ED395 (user_id), INDEX IDX_97A0ADA313457256 (technicien_id), UNIQUE INDEX UNIQ_97A0ADA38EAE3863 (intervention_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
