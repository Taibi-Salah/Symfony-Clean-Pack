 ...
 */
final class Version20240710114609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facturation (id INT AUTO_INCREMENT NOT NULL, value JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE intervention_stock (id INT AUTO_INCREMENT NOT NULL, intervention_id INT NOT NULL, stock_id INT NOT NULL, INDEX IDX_3E534AE48EAE3863 (intervention_id), INDEX IDX_3E534AE4DCD6110 (stock_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
