 ...
 */
final class Version20240709162325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facturation (id INT AUTO_INCREMENT NOT NULL, value JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE intervention_stock (id INT AUTO_INCREMENT NOT NULL, intervention_id INT NOT NULL, stock_id INT NOT NULL, INDEX IDX_3E534AE48EAE3863 (intervention_id), INDEX IDX_3E534AE4DCD6110 (stock_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE stock (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, reference_nb VARCHAR(255) NOT NULL, quantity INT NOT NULL, is_active TINYINT(1) NOT NULL, supplier_id INT DEFAULT NULL, INDEX IDX_4B3656602ADD6D8C (supplier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, user_id INT DEFAULT NULL, technicien_id INT DEFAULT NULL, intervention_id INT DEFAULT NULL, INDEX IDX_97A0ADA3A76ED395 (user_id), INDEX IDX_97A0ADA313457256 (technicien_id), UNIQUE INDEX UNIQ_97A0ADA38EAE3863 (intervention_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, roles VARCHAR(50) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, contact_information_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D6495D0DBFC1 (contact_information_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
